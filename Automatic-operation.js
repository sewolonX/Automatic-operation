...
<div class="auto-op-row-switch"><label>选取元素放行点击</label><label class="auto-op-switch"><input type="checkbox" id="auto-op-pick-pass-through"><span class="auto-op-switch-track"><span class="auto-op-switch-thumb"></span></span></label></div>
  ...
  `;
	...
	function onDragStart(e) {
		if (e.target === toggleBtn || toggleBtn.contains(e.target) || e.target === btnHeaderStart || btnHeaderStart.contains(e.target) || e.target === configBtnEl || configBtnEl.contains(e.target) || e.target === infoBackBtn || infoBackBtn.contains(e.target) || e.target === settingsBackBtn || settingsBackBtn.contains(e.target)) return;
		isDragging = true;
		closeConfigMenu();
